---
title: "Identity Continuity During Rewrite"
number: "264"
part: 18
part_roman: XVIII
...
summary: "Identity Continuity During Rewrite is documented as Generation-Zero canon rather than a generic permission for every Noxivitre. The focus is the transition from accepted body-map change to physical restructuring, stabilization, diagnostics, and the conditions…"
prev_url: "/plates/263-founder-sensory-overload/"
prev_title: "Founder Sensory Overload"
next_url: "/plates/265-founder-memory-continuity/"
next_title: "Founder Memory Continuity"
---

Identity Continuity During Rewrite is documented as Generation-Zero canon rather than a generic permission for every Noxivitre. The focus is the transition from accepted body-map change to physical restructuring, stabilization, diagnostics, and the conditions that can interrupt or reject the change. Riven and Blade are the first Noxivitres and the first confirmed Unobtanium members, but founder status is not a shortcut that makes every one of their visible traits locked. Their six permanent arms, floating anatomy, segmentation, unusual faces, additional sensors, and other extreme features can have open analogues at lower tiers. What distinguishes founder-class Unobtanium is their Origin Glassheart architecture and ability to author new stable body-map pathways. Character-specific decisions remain with the respective owners.
...
| **DESIGN TEST**        | If identity continuity during rewrite disappeared from a scene, would movement, maintenance, accessibility, behavior, or visual identity noticeably change? If not, it needs more concrete consequences. |
...
The short version is useful, but **Identity Continuity During Rewrite** becomes a lot easier to write once it is treated as part of somebody’s ordinary life.

The useful questions here are **the accepted body map, Glassheart arbitration, rewrite state, material supply, and the point where a temporary change becomes stable anatomy**. That is the technical side, but it should show up in ordinary life instead of only in diagrams. With **Identity Continuity During Rewrite**, practical details can include ordinary social interaction, maintenance, sleep, and privacy. A character who has had the feature for years usually handles those things without thinking; somebody who acquired it recently may still misjudge space, overcorrect, or consciously plan movements that will eventually become automatic.

Decide what **Identity Continuity During Rewrite** feels like from the inside. It might register as ordinary proprioception, pressure, a quiet digital position sense, background diagnostics, or almost nothing until something goes wrong. Useful warning signs for this feature include extra heat or energy use, temporary fallback behavior, and slower response. Those signs do not need to mean catastrophic failure. Noxivitre systems usually degrade in layers, so reduced precision or a safer fallback state often appears before anything truly dangerous happens.

For artists and writers, give **Identity Continuity During Rewrite** at least one repeatable visual or behavioral tell. Possibilities include a more compact resting state, visible nanite traffic under load, and subtle BlackGlass seams. Keep the tell consistent enough that it feels like the same body from scene to scene. Also test the feature somewhere inconvenient but mundane: a cramped vehicle, an unfamiliar bed, a clinic designed for fixed anatomy, or a crowded hallway. If the design still has a believable answer there—perhaps through maintenance, movement, and clothing—the rule is doing real work instead of existing only for spectacle.

If a character breaks the normal version of **Identity Continuity During Rewrite**, write down what is compensating for the exception and what tradeoff appears somewhere else. A failed rewrite can stop at a stable intermediate state; the system would rather pause than keep changing blindly. Rarity should still be judged from the whole build. A visually extreme version can remain inside the open tiers, including Mythic, when it does not use creator-reserved founder authority. Unobtanium is not a reward for having the loudest silhouette.

#### Questions worth answering

- What would a Noxivitre medic see about **Identity Continuity During Rewrite** that an ordinary observer would miss?
- Does **Identity Continuity During Rewrite** behave differently during a Glassshift, active repair, or emotional stress?
- Which parts of **Identity Continuity During Rewrite** are automatic, and which can be deliberately controlled?

A technical plate for **Identity Continuity During Rewrite** should be understandable on its own. Cross-references can add depth, but the reader should not have to chase three other sections just to learn what the system does, what supports it, and what a visible problem would look like.
