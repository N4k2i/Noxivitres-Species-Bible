...
summary: "Color Is Not Rarity is part of the species-facing design layer. Its purpose is how rarity describes total integrated complexity rather than color, social value, raw power, or a single impressive trait. The open-species rules deliberately allow dramatic anatom…"
prev_url: "/plates/179-whole-body-plan-complexity/"
prev_title: "Whole-Body-Plan Complexity"
next_url: "/plates/181-open-species-permission-rules/"
next_title: "Open-Species Permission Rules"
---

Color Is Not Rarity is part of the species-facing design layer. Its purpose is how rarity describes total integrated complexity rather than color, social value, raw power, or a single impressive trait. The open-species rules deliberately allow dramatic anatomy through Mythic, so the question is rarely "is this trait allowed?" and more often "does the entire design have a coherent complexity level and understandable consequences?" Rarity is a classification tool, not a caste system. Social treatment, attractiveness, morality, competence, and power are not assigned by tier. Good character design combines silhouette, anatomy, maintenance, environment, clothing, relationships, and culture instead of using rarity as the only source of identity.
...
| **DESIGN TEST**        | If color is not rarity disappeared from a scene, would movement, maintenance, accessibility, behavior, or visual identity noticeably change? If not, it needs more concrete consequences. |
...
A good version of **Color Is Not Rarity** feels specific to the person wearing it. The system can be technically complicated without making the character talk like a manual.

The useful questions here are **whole-body complexity, dependency count, active BlackGlass load, stability, and whether the concept changes canon authority rather than merely appearance**. That is the technical side, but it should show up in ordinary life instead of only in diagrams. With **Color Is Not Rarity**, practical details can include sleep, maintenance, privacy, and clothing. A character who has had the feature for years usually handles those things without thinking; somebody who acquired it recently may still misjudge space, overcorrect, or consciously plan movements that will eventually become automatic.

Decide what **Color Is Not Rarity** feels like from the inside. It might register as ordinary proprioception, pressure, a quiet digital position sense, background diagnostics, or almost nothing until something goes wrong. Useful warning signs for this feature include temporary fallback behavior, extra heat or energy use, and slower response. Those signs do not need to mean catastrophic failure. Noxivitre systems usually degrade in layers, so reduced precision or a safer fallback state often appears before anything truly dangerous happens.

For artists and writers, give **Color Is Not Rarity** at least one repeatable visual or behavioral tell. Possibilities include subtle BlackGlass seams, a more compact resting state, and visible nanite traffic under load. Keep the tell consistent enough that it feels like the same body from scene to scene. Also test the feature somewhere inconvenient but mundane: a cramped vehicle, an unfamiliar bed, a clinic designed for fixed anatomy, or a crowded hallway. If the design still has a believable answer there—perhaps through movement, privacy, and maintenance—the rule is doing real work instead of existing only for spectacle.

If a character breaks the normal version of **Color Is Not Rarity**, write down what is compensating for the exception and what tradeoff appears somewhere else. A classification disagreement should be solved by examining system complexity, not by arguing over which design looks more impressive. Rarity should still be judged from the whole build. A visually extreme version can remain inside the open tiers, including Mythic, when it does not use creator-reserved founder authority. Unobtanium is not a reward for having the loudest silhouette.

#### Questions worth answering

- What would a Noxivitre medic see about **Color Is Not Rarity** that an ordinary observer would miss?
- Does **Color Is Not Rarity** behave differently during a Glassshift, active repair, or emotional stress?
- How does **Color Is Not Rarity** affect clothing, furniture, sleep, travel, or personal space?

A technical plate for **Color Is Not Rarity** should be understandable on its own. Cross-references can add depth, but the reader should not have to chase three other sections just to learn what the system does, what supports it, and what a visible problem would look like.
