...
summary: "Vehicle Design is part of the species-facing design layer. Its purpose is how a mutable or nonstandard body changes real-world fit, clearances, fastening, safety, comfort, and accessibility rather than only changing appearance. The open-species rules delibera…"
prev_url: "/plates/196-door-and-hallway-design/"
prev_title: "Door and Hallway Design"
next_url: "/plates/198-workplace-accommodation/"
next_title: "Workplace Accommodation"
---

Vehicle Design is part of the species-facing design layer. Its purpose is how a mutable or nonstandard body changes real-world fit, clearances, fastening, safety, comfort, and accessibility rather than only changing appearance. The open-species rules deliberately allow dramatic anatomy through Mythic, so the question is rarely "is this trait allowed?" and more often "does the entire design have a coherent complexity level and understandable consequences?" Rarity is a classification tool, not a caste system. Social treatment, attractiveness, morality, competence, and power are not assigned by tier. Good character design combines silhouette, anatomy, maintenance, environment, clothing, relationships, and culture instead of using rarity as the only source of identity.
...
| **DESIGN TEST**        | If vehicle design disappeared from a scene, would movement, maintenance, accessibility, behavior, or visual identity noticeably change? If not, it needs more concrete consequences. |
