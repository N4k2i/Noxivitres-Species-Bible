...
summary: "Aquatic Environments addresses the practical side of living in a mutable body. Technology and medicine should account for changing dimensions, detached anatomy, nanite compatibility, and the possibility that a patient's current body map is not the one they ha…"
prev_url: "/entries/241-hot-environments/"
prev_title: "Hot Environments"
next_url: "/entries/243-vacuum-and-low-pressure-concepts/"
next_title: "Vacuum and Low-Pressure Concepts"
---
Aquatic Environments addresses the practical side of living in a mutable body. Technology and medicine should account for changing dimensions, detached anatomy, nanite compatibility, and the possibility that a patient's current body map is not the one they had last year.
...
- Write at least one mundane consequence of aquatic environments so the feature still feels real outside transformation scenes.
